  ...
  <aside class="w-full md:w-72 p-5 bg-white rounded-xl shadow border text-[#111] space-y-6">
    ...
    <div>
      ...
      <ul class="space-y-1 text-sm">
        <li><label class="cursor-pointer"><input type="checkbox" class="mr-2" disabled /> Eau de Parfum</label></li>
        <li><label class="cursor-pointer"><input type="checkbox" class="mr-2" disabled /> Eau de Toilette</label></li>
        <li><label class="cursor-pointer"><input type="checkbox" class="mr-2" disabled /> Extrait de Parfum</label></li>
      </ul>
    </div>
